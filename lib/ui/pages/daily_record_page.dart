...
class _DailyRecordPageState extends State<DailyRecordPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Stack(children: <Widget>[
          ...
          CustomScrollView(
              physics: BouncingScrollPhysics(), slivers: _buildRecordPart()),
        ]));
  }
  ...
  _changeSwitch(bool e) async {
    setState(() {
      ...
      if (_onlyIncorrect) {
        _questions =
            widget.questions.where((question) => !question.judgment).toList();
      } else {
        _questions = widget.questions;
      }
    });
      ...
      Align(
          ...
          child: Container(
              ...
              child: Align(
                  ...
                  child: Padding(
                      padding: const EdgeInsets.only(top: 4.0, left: 30.0, right: 40.0),
                      child: Text(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      // width: 40.0,
                      child: Text("${formatTime(question.answeredTime)}",
                          style: TextStyle(
                              fontSize: MediaQuery.of(context).size.width > 600
                                  ? 14.0
                                  : 8.0,
