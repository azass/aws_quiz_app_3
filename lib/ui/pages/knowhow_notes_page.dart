...
class KnowhowNotesView extends StatelessWidget {
  ...
  Widget _buildNoteCard(BuildContext context, KnowhowNote note) {
    return Card(
      ...
      child: ExpansionTile(
        ...
        children: <Widget>[
          Padding(
            padding: EdgeInsets.only(left: 14.0, right: 14.0, bottom: 12.0),
            child: Align(
  ...
  MarkdownStyleSheet _darkMarkdownStyle(BuildContext context) {
    return MarkdownStyleSheet.fromTheme(Theme.of(context)).copyWith(
      ...
      listBullet: TextStyle(fontSize: 12.0, height: 1.6, color: Colors.white70),
      strong: TextStyle(
        fontSize: 12.5,
        fontWeight: FontWeight.bold,
        color: Colors.white,
