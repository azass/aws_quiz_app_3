  ...
  Widget _buildQuadrants(Quadrants q) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            _quadrantCard("最優先", "難×忘れかけ", q.danger, Colors.red.shade400),
            SizedBox(width: 6.0),
            _quadrantCard("軽く復習", "易×忘れかけ", q.effort, Colors.orange.shade400),
          ],
        ),
        SizedBox(height: 6.0),
        Row(
          children: [
            _quadrantCard("油断注意", "難×維持中", q.fragile, Colors.amber.shade600),
            SizedBox(width: 6.0),
            _quadrantCard("安定", "易×維持中", q.stable, Colors.green.shade400),
          ],
        ),
        Padding(
        ...
        SizedBox(
          ...
          child: SfCartesianChart(
            ...
            primaryXAxis: CategoryAxis(
              labelStyle: TextStyle(fontSize: 8.0, color: Colors.white70),
            ...
            series: <CartesianSeries>[
              ColumnSeries<_BarData, String>(
                ...
                dataLabelSettings: DataLabelSettings(
                  isVisible: true,
                  textStyle: TextStyle(fontSize: 8.0, color: Colors.white70),
                ),
              ),
            ],
          ),
      ...
      children: [
        ...
        SizedBox(
          ...
          child: SfCartesianChart(
            ...
            plotAreaBorderWidth: 0,
            primaryXAxis: CategoryAxis(
              labelStyle: TextStyle(fontSize: 9.0, color: Colors.white70),
              majorGridLines: MajorGridLines(width: 0),
            ),
            primaryYAxis: NumericAxis(
              labelStyle: TextStyle(fontSize: 8.0, color: Colors.white70),
