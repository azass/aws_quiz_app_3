...
class WordsDialog extends StatefulWidget {
  ...
  final ValueNotifier<String> _selectedWord = ValueNotifier("");
  final ValueNotifier<int> _selectedLevel = ValueNotifier(1);
  final ValueNotifier<bool> _selected = ValueNotifier(false);

  String get selectedWord => _selectedWord.value;
  set selectedWord(String value) => _selectedWord.value = value;
  int get selectedLevel => _selectedLevel.value;
  set selectedLevel(int value) => _selectedLevel.value = value;
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Dismissible(
                  ...
                  child: ListTile(
                    ...
                    tileColor: word.checkOn ? Colors.yellow[100] : Colors.white,
                    onTap: () {
                      setState(() {
