...
class QuizAppBar extends StatelessWidget {
  ...
  QuizAppBar(this.questId, this.estimatedTime, this.currentIndex,
      this.questionsLength, this.readOnly, this.isAnswered);
  ...
  Widget build(BuildContext context) {
    return Row(
        ...
        children: <Widget>[Text(questId), _buildPointText()]);
  }
  ...
  Widget _buildPointText() {
    return Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
      ...
      RichText(
        ...
        if (!readOnly)
          TextSpan(
            text: '${questionsLength - currentIndex - (isAnswered ? 1 : 0)} ',
            style: TextStyle(
              color: Colors.white,
              fontSize: 16.0,
